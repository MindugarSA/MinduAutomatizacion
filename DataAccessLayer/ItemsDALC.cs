...
namespace DataAccessLayer
{
    public class ItemsDALC
    {
        ...
        public DataTable GetItemsProductosParteGerencia(string TipoItem)
        {
            //using (DB_AUTOMATIZACIONEntities db = new DB_AUTOMATIZACIONEntities())
            //{
            //    if (db.Database.Connection.State == ConnectionState.Closed)
            ...
            try
            {
                string sp = "[SP_ListadoItemPartesGerencia]";
        ...
        public DataTable GetItemsEstadoProductosTerminadosGerencia(string TipoItem)
        {
            ...
            try
            {
                string sp = "[SP_ProductosTerminadosGerencia]";
